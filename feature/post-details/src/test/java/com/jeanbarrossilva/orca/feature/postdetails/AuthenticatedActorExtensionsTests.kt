...
internal class AuthenticatedActorExtensionsTests {
  @Test
  fun createsCommentingFromAuthenticatedActor() {
    val actor = Actor.Authenticated.sample
    assertThat(actor.asCommenting())
      .isEqualTo(PostDetails.Commenting(actor.avatarLoader as SomeComposableImageLoader))
  }
}
