 ...
 */
internal val BoldSpanStyle = SpanStyle(fontStyle = FontStyle.Italic)
 ...
 * @see StyledString.toAnnotatedString
 */
internal fun createLinkSpanStyle(colors: Colors): SpanStyle {
  return SpanStyle(colors.link.asColor)
}
